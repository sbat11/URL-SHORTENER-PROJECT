...
class Form extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        var generatedURL = "https://mini-url-7145a11c0eab.herokuapp.com/" + generatedKey

        if (this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "https://mini-url-7145a11c0eab.herokuapp.com/" + this.state.preferedAlias
        }
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">https://mini-url-7145a11c0eab.herokuapp.com//</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
